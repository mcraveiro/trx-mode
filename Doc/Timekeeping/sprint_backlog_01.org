...
#+CAPTION: Clock summary at [2024-03-29 Fri 14:11]
| <75>                                        |        |      |       |
| Headline                                    | Time   |      |     % |
|---------------------------------------------+--------+------+-------|
...
|---------------------------------------------+--------+------+-------|
| Stories                                     | 5:31   |      | 100.0 |
| Backlog refinement                          |        | 0:33 |  10.0 |
| Generate test data files for sample project |        | 0:11 |   3.3 |
| Read boost-test code to get ideas           |        | 0:33 |  10.0 |
| Download and install omnisharp              |        | 0:20 |   6.0 |
| Ensure build works with xunit               |        | 0:19 |   5.7 |
| Print XML properly in ielm                  |        | 0:21 |   6.3 |
| Clean up folder structure                   |        | 0:24 |   7.3 |
| Create a simple function to read TRX XML    |        | 0:06 |   1.8 |
| Create a summary buffer from TRX content    |        | 0:06 |   1.8 |
| Investigate sharper's way to find solutions |        | 1:02 |  18.7 |
| Investigate eglot's use of project          |        | 0:27 |   8.2 |
| Create a basic tree widget with projects    |        | 1:09 |  20.8 |
#+end:
